...
const btnClass =
  'inline-flex w-full items-center justify-center gap-2 rounded-md border border-gray-200 bg-white px-4 py-2.5 text-sm font-semibold uppercase tracking-tight text-gray-900 transition-colors hover:bg-gray-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/40';
...
export function SignInProviderButtons({ callbackUrl = '/', layout = 'stack' }) {
  ...
  return (
    <div className={wrap}>
      {showGoogle ? (
      <button type="button" className={btnClass} onClick={onGoogle}>
      ...
      {showYandex ? (
      <button type="button" className={btnClass} onClick={onYandex}>
