...
const CSSModal = ({ isOpen, onClose, cssCode, fontName }) => {
  ...
  const copyToClipboard = () => {
    if (textareaRef.current) {
      ...
      notification.className = 'fixed top-4 right-4 bg-gray-800 text-white px-4 py-2 rounded-md shadow-lg z-50 animate-fadeIn';
      ...
      >
        ...
        <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end space-x-4">
          <button
            ...
            className="px-4 py-2 bg-accent text-white rounded hover:bg-accent-hover transition-colors flex items-center focus:outline-none focus:ring-2 focus:ring-accent focus:ring-opacity-50 shadow-sm"
          >
