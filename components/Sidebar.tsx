    ...
    >
      <div className="flex h-12 min-h-12 shrink-0 items-center justify-center border-b border-gray-200 px-4">
        <button
          ...
          className="inline-flex cursor-pointer items-center gap-3 rounded-md px-1 py-0.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
          aria-label="Все шрифты"
          title="Все шрифты"
        >
          <img
          ...
          <div className="mb-4 flex flex-col gap-2">
            <div className="flex min-w-0 flex-wrap items-center justify-between gap-2">
              ...
              <SegmentedControl
                ...
                onChange={(v) => setVerticalAlignment(v as VerticalAlignment)}
            ...
            <div className="flex min-h-8 min-w-0 items-stretch gap-2">
              <div className="flex min-w-0 flex-[4] items-stretch gap-2">
                ...
                <SegmentedControl
                  ...
                  onChange={(v) =>
                    setTextDecoration(
                      (v === textDecoration ? 'none' : v) as TextDecoration,
                    )
                  }
              ...
              <div className="flex min-w-0 flex-col gap-2">
                <CustomSelect
                  ...
                  onChange={(v) => {
                    ...
                    const p = WATERFALL_SCALE_PRESETS.find((x) => x.key === key);
                    if (p) {
                      setWaterfallScaleSelectKey(key);
