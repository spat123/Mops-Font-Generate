...
export type CustomSelectTriggerClassOptions = {
  compact?: boolean;
  placeholderMuted?: boolean;
};

/** Триггер {@link CustomSelect}. */
export function customSelectTriggerClass({ compact = false, placeholderMuted = false }: CustomSelectTriggerClassOptions = {}) {
...
/** @deprecated Используйте {@link customSelectTriggerClass}. */
export function nativeSelectFieldClass(opts?: CustomSelectTriggerClassOptions) {
