...
export function FloatingTooltip({
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    let side: TooltipPlacement = sideProp;
...
export type TooltipSide = TooltipPlacement | 'auto';
...
export type TooltipProps = {
  ...
  disabled?: boolean;
} & Omit<React.HTMLAttributes<HTMLElement>, 'content' | 'children' | 'className' | 'title' | 'type' | 'disabled'>;
...
export function Tooltip({
  ...
  const updatePos = useCallback(() => {
    ...
    let side: TooltipPlacement = sideProp === 'auto' ? 'top' : sideProp;
    if (sideProp === 'auto') {
