...
import type { BillingLocale, BillingPeriod } from '../../utils/billingPlans';
...
export function PlansDialog({ open, onClose, currentPlan = 'Free', locale = 'RU' }: PlansDialogProps) {
      ...
      >
        ...
        <div className="min-h-0 flex-1 overflow-y-auto bg-gray-50/50 px-6 py-6">
          <div className="mx-auto flex max-w-xs flex-col items-center gap-4">
            <SegmentedControl
              value={billingPeriod}
              onChange={(period) => setBillingPeriod(period as BillingPeriod)}
