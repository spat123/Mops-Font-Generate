export type PopupDialogHeaderProps = {
  title: string;
  onClose: () => void;
  className?: string;
  titleClassName?: string;
  closeAriaLabel?: string;
  /** Подсказка слева от разделителя перед кнопкой закрытия (например «ESC»). `null` — скрыть. */
  closeShortcutHint?: string | null;
};
