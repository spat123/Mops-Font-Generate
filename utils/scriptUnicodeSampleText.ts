...
function joinRanges(ranges: UnicodeRange[]): string {
  let out = '';
...
const SCRIPT_UNICODE_BLOCKS: Record<string, UnicodeRange[]> = {
  limbu: [[0x1900, 0x194f]],
  thai: [[0x0e01, 0x0e5e]],
...
export function scriptUnicodeGlyphSample(subsetKey: string): string {
