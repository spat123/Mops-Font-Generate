...
export function isValidVariationAxisTag(tag) {
 ...
 * @param {Record<string, unknown> | null | undefined} [knownAxes] — variableAxes шрифта; если заданы, чужие ключи отбрасываются
 */
export function sanitizeVariableSettingsForInstancer(settings, knownAxes = null) {
  const out = {};
  const allowed =
