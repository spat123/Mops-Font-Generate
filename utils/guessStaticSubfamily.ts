...
function guessWeightName(wght: unknown): string {
 ...
 */
export function variableFontHasItalicAxis(
...
export function guessSubfamilyForVariableFont(
  ...
  const ital =
    axes && Object.prototype.hasOwnProperty.call(axes, 'ital') && allowItalic ? settings?.ital : undefined;
  const slnt =
