...
export default function PrivacyPage() {
  return (
    <>
      <Head>
        <title>Политика конфиденциальности — DINAMIC FONT</title>
      </Head>
      <div className="min-h-screen bg-gray-50 px-4 py-12">
        <div className="mx-auto w-full max-w-2xl rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
          <h1 className="text-lg font-semibold uppercase tracking-tight text-gray-900">Политика конфиденциальности</h1>
          <p className="mt-3 text-sm leading-relaxed text-gray-600">
            Черновик. Позже сюда добавим корректный текст политики конфиденциальности.
          </p>
          <Link
            href="/auth/signup"
