...
function formatGenerationError(error: unknown) {
  const raw = String((error instanceof Error ? error.message : error) || 'Unknown error');
...
async function handleGenerateStaticFont(req: NextApiRequest, res: NextApiResponse) {
